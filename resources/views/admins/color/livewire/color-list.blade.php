<div>
    {{-- @if (section('success'))
        <span class="alert alert-success p-2">{{ session('success') }}</span>
    @endif --}}
    <div class="card">
        <div class="card-header">
            <h5 class="card-title floar-left d-inline">Color</h5>
            <button type="button" class="btn btn-success float-right" data-toggle="modal" data-target="#crudColorModal"
                wire:ignore.self>
                Add New
            </button>
        </div>
                    ...
                    <thead class="thead-dark">
                        <tr role="row">
                            ...
                            <th class="sorting" tabindex="0" aria-controls="DataTables_Table_0" rowspan="1"
                                colspan="1" aria-label="Code: activate to sort column ascending">Code</th>
                            ...
                            <tr class="odd">
                                ...
                                <td class="text-center">
                                    <button type="button" class="btn btn-sm btn-primary " data-toggle="modal"
                                        data-target="#crudColorModal" data-color-id="{{ $value->id }}"
                                        title="Edit">
