<div id="modal_remote_{{ $id_product }}" class="modal" tabindex="-1" wire:ignore.self>
                                    ...
                                    <div class="" style="display: block;">
                                        <div class="text-left">
                                            <a class="btn btn-secondary" data-toggle="collapse" href="#color"
                                                ...
                                                wire:ignore.self wire:click="resetColumn()"><i
                                                            ...
                                                            <div class="row">
                                                                ...
                                                                <div class="mb-3 col-4">
                                                                    <div class="row">
                                                                        ...
                                                                        <div class="input-group">
                                                                            <input type="file"
                                                                                wire:model="fabriccolor" hidden
                                                                                id="cover_fabriccolor">
