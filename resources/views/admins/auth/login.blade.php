    ...
    <div class="navbar navbar-expand-lg navbar-dark bg-indigo navbar-static">
        <div class="navbar-brand ml-2 ml-lg-0">
            <a href="index.html" class="d-inline-block">
                <img src="{{ URL::asset('admins/global_assets/images/logo_light.png') }}" alt="">
            </a>
        </div>
                        ...
                        <div class="card mb-0">
                            <div class="card-body">
                                ...
                                <div class="form-group text-center">
                                    <button type="button"
                                        class="btn btn-outline-indigo btn-icon rounded-pill border-2"><i
                                            class="icon-facebook"></i></button>
                                    <button type="button"
                                        class="btn btn-outline-pink btn-icon rounded-pill border-2 ml-2"><i
                                    ...
                                    <button type="button"
                                        class="btn btn-outline-info btn-icon rounded-pill border-2 ml-2"><i
